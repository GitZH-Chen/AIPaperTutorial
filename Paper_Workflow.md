...
AI 的价值是快速生成一个供人批判和修改的初稿。无论是论文正文、proof、review、rebuttal 还是 camera-ready revision，首先都要告诉 AI 具体怎么做并提供充分上下文，然后通过多轮讨论、局部修改和人工重写，把初稿改成准确、清晰、可以投稿的文本。如果最终版本仍与 AI 第一稿基本相同，通常说明作者投入的判断和迭代还不够，甚至可能说明作者本人对所写内容一窍不通。**把这样的草稿给专业的人看，无异于裸奔，因为它会毫无遮掩地暴露作者对内容缺乏最基本的理解**。
